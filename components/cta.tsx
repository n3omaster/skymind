        ...
        <div className="relative px-8 py-12 md:py-20 rounded-[3rem] overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-slate-400 mb-8">
              We are here to help you to take control of your business and make
              it more secure and profitable, using the most modern technologies
              and the best practices in the market.
            </p>
            <div>
              <a
