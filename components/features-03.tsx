        ...
        <div className="pt-16 pb-12 md:pt-32 md:pb-20 border-b border-slate-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">
              Your business on {new Date().getFullYear() + 1}
            </h2>
            <p className="text-lg text-slate-400">
              Always be one step ahead of your competitors. We work with the
              most modern technologies to deliver the best in class solutions
              for your business and selling improvement.
            </p>
          </div>
